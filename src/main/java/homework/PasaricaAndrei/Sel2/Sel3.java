...
public class Sel3 {
    public static void main(String[] args) {
        ...
        try {
            ...
            WebElement elementInexistent = driver.findElement(By.id("acest id nu exista"));

            elementInexistent.click();

        } catch (NoSuchElementException e) {
            System.out.println("Elementul nu a fost găsit se face un screenshot");
